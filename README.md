...
The Medical Information Mart for Intensive Care (MIMIC) datasets are large, open-source, de-identified, critical care databases, comprised patient health records for those admitted to the critical care units of the Beth Israel Deaconess Medical Center in Boston MA, from 2001-2019.
